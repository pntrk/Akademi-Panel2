            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
                <div className="bg-white p-3.5 rounded-2xl border border-[#e6e2d3] space-y-1">
                  <span className="text-[#8e8d82] text-[11px] font-semibold">Firebase Proje Kimliği:</span>
                  <p className="font-mono font-bold text-[#5a5a40]">{firebaseConfig.projectId}</p>
                  <span className="text-[10px] text-emerald-600 font-semibold block">Firestore Database: (default)</span>
                </div>
